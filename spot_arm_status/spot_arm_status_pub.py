...
class JointStateSubscriber(Node):
    ...
    def is_arm_stowed(self, arm_values):
        joint_stowed = [
    ...
    def is_gripper_values(self, gripper_position):
        gripper_out = gripper_position < -0.03
        return gripper_out
    ...
    def joint_state_callback(self, msg):
        ...
        gripper_open_msg.data = self.is_gripper_values(gripper_position)
        ...
        arm_stowed = self.is_arm_stowed(arm_values)
        arm_stowed_msg = Bool()
